...
let diagramming_samples = ['Anchors', 'Animations', 'Containers', 'ControlNodes', 'Controls', 'DBDesign', 'DomTree', 'DragDrop', 'Flowcharter', 'FlowchartLayout', 'FractalLayout',
	'Inheritance', 'Lanes', 'LayeredLayout', 'MultipleViews', 'PathFinder', 'SpanningCells', 
	'StockShapes', 'SvgNodes', 'TabbedView', 'Themes', 'TreeLayout', 'TreeMap', 
	'TreeViewNodes', 'WebComponents',
	...
	plugins: [
		...
		new CopyPlugin({
			patterns: [
				...
				{ from: './src/mindfusion_lic.txt', to: './Pack' },
				{ from: './src/mindfusion_lic.txt', to: './Diagramming' },
				{ from: './src/mindfusion_lic.txt', to: './Charting' },
				{ from: './src/mindfusion_lic.txt', to: './Scheduling' },
				{ from: './src/mindfusion_lic.txt', to: './Mapping' },
				{ from: './src/mindfusion_lic.txt', to: './Keyboard' },
				{ from: './src/mindfusion_lic.txt', to: './DataViews' },
				{ from: './src/mindfusion_lic.txt', to: './UI' },
				{ from: './src/UI/themes/icons/black', to: './Diagramming/icons/black' },
			],
		})
