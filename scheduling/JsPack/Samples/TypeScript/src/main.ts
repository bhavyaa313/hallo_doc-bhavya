...
},
{
    ...
    href: "./Pack/WorldPopulation.html",
...
var data3 = [{
    ...
    items: [
        ...
        { title: "TabbedView", href: "./Diagramming/TabbedView.html" },
        ...
        { title: "Web Components", href: "./Diagramming/WebComponents.html" },
...
},
{
    ...
    items: [
        ...
        { title: "CustomItem", href: "./Scheduling/CustomItem.html" },
    ]
},
{
...
function generateTemplate(data)
{
    ...
    else
    {
        ...
        img.src = "./assets/screenshots/" + data.title + ".png";
        img.style.width = "100%";
        a.href = data.href;
        a.appendChild(img);
        t.appendChild(a);
