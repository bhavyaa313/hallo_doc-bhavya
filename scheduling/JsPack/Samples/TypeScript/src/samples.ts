...
document.addEventListener("DOMContentLoaded", function () {
	...
	Control.licenseLocation = "mindfusion_lic.txt";
});
...
import ui_black from '@mindfusion/common-ui/themes/black.css';
import ui_sky from './UI/themes/sky.css';
export { ui_blue, ui_business, ui_earth, ui_gray, ui_green, ui_light, ui_pastel, ui_peach, ui_standard, ui_black, ui_sky };