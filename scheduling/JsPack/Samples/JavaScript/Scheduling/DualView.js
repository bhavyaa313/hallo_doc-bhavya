...
calendar.timetableSettings.scrollStep = 1;
...
calendar2.weekRangeSettings.visibleRows = 10;
...
function filter()
{
	...
	var resource = calendar.schedule.contacts.items()[document.getElementById("contacts").value];
