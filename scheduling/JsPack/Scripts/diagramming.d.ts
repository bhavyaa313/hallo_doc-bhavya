...
/// <reference types="../../@mindfusion/animations" />
...
declare module "Diagramming/Enum" {
    ...
    export namespace Behavior {
        ...
        const PanAndModify: number;
        const MoveNodes: number;
        const Zoom: number;
        const MoveLabels: number;
    }
    /**
     ...
     */
    export type RelativeToNode = number;
    export namespace RelativeToNode {
        export const Edge: number;
        export const Corner: number;
...
declare module "Diagramming/ItemLabel" {
    /**
    * @class Represents a label displayed by a DiagramItem.
    */
    export class ItemLabel {
        /**
        * Initializes a new instance of the ItemLabel class.
        * @constructor
        * @param {DiagramItem} item The DiagramItem that displays the label.
        * @param {String} text The label's text.
        */
        constructor(item: any, text: string);
        item: any;
        _text: Text;
        cachedLayoutRect: Rect;
        set horizontalOffset(arg: number);
        /**
        * Gets or sets label's horizontal offset from its pin point.
        * @type {Number}
        * @summary A number specifying label's horizontal position, specified in diagram's measureUnit.
        */
        get horizontalOffset(): number;
        set verticalOffset(arg: number);
        /**
        * Gets or sets label's vertical offset from its pin point.
        * @type {Number}
        * @summary A number specifying label's vertical position, specified in diagram's measureUnit.
        */
        ...
        */
        ...
        set enableWrap(arg: boolean);
        /**
        * Gets or sets a value indicating whether text wrapping is enabled.
        * @type {Boolean}
        * @summary true to wrap the label's text; or false otherwise.
        */
        get enableWrap(): boolean;
        ...
        * @type {Boolean}
        * @summary true to parse the label's text in order to find formatting tags; or false otherwise.
        */
        ...
        */
        ...
        createEditArgs(oldText: any, newText: any): void;
        unrotatedPoint(p: any): any;
...
declare module "Diagramming/LinkLabel" {
    ...
    * @augments ItemLabel
    */
    export class LinkLabel extends ItemLabel {
        _lengthFactor: number;
    ...
    import { ItemLabel } from "Diagramming/ItemLabel";
}
declare module "Diagramming/NodeLabel" {
    /**
    * @class Represents a label displayed by a DiagramNode. New labels can be added to a node by calling its addLabel method.
    * @augments ItemLabel
    */
    export class NodeLabel extends ItemLabel {
        get node(): any;
        /**
        * Positions this label relatively to the specified node edge.
        * @param {Number} edge The edge index.
        * @param {Number} dx Horizontal offset from the edge center.
        * @param {Number} dy Vertical offset from the edge center.
        */
        setEdgePosition(edge: number, dx: number, dy: number): void;
        /**
        * Positions this label relatively to the specified corner point.
        * @param {Number} cornerPoint The corner point index.
        * @param {Number} dx Horizontal offset from the corner point.
        * @param {Number} dy Vertical offset from the corner point.
        */
        setCornerPosition(cornerPoint: number, dx: number, dy: number): void;
        /**
        * Positions this label relatively to the node center.
        * @param {Number} dx Horizontal offset from the center point.
        * @param {Number} dy Vertical offset from the center point.
        */
        setCenterPosition(dx: number, dy: number): void;
        cachedLayoutSize: any;
        /**
        * For internal use only.
        * @private
...
declare module "Diagramming/EventArgs" {
    ...
    */
    export class NodeEventArgs extends ItemEventArgs {
        ...
        */
        ...
        /**
        * Gets the node label for which the event is raised.
        * @type {NodeLabel}
        * @summary A NodeLabel instance.
        */
        get label(): NodeLabel;
    }
    /**
    ...
    */
    export class LinkEventArgs extends ItemEventArgs {
        ...
        * @type {DiagramNode}
        * @summary A DiagramNode instance.
        */
    ...
    */
    export class DiagramEventArgs extends EventArgs {
        ...
        * @type {Number}
        * @summary The horizontal scroll amount.
        */
        get deltaX(): number;
    }
    /**
    ...
    */
    export class SerializeTagEventArgs extends EventArgs {
        ...
        */
        ...
        set jsonObject(arg: any);
        /**
        * Gets or sets the object representing the tag.
        * @type {Object}
        * @summary The object represeting the tag.
        * @remarks Used in JSON serialization.
        */
        get jsonObject(): any;
    }
    /**
    ...
    */
    ...
    /**
    * @class Contains the arguments passed to handlers of the validateLinkCrossing event.
    * @augments CancelEventArgs
    */
    export class LinkCrossingEventArgs extends CancelEventArgs {
        /**
        ...
        */
        ...
        sender: any;
        _topLink: any;
        _topSegmentIndex: any;
        _bottomLink: any;
        _bottomSegmentIndex: any;
        _intersectionPoint: any;
        /**
        * The link at higher Z position.
        * @type {DiagramLink}
        * @summary An instance of the DiagramLink class.
        */
        get topLink(): DiagramLink;
        /**
        * Index of top link's segment that contains the intersection point.
        * @type {Number}
        * @summary An integer index of link's segment containing intersectionPoint.
        */
        get topSegmentIndex(): number;
        /**
        * The link at lower Z position.
        * @type {DiagramLink}
        * @summary An instance of the DiagramLink class.
        */
        get bottomLink(): DiagramLink;
        /**
        * Index of bottom link's segment that contains the intersection point.
        * @type {Number}
        * @summary An integer index of link's segment containing intersectionPoint.
        */
        get bottomSegmentIndex(): number;
        /**
        * Intersection point that will show crossing decoration if the event is validated.
        * @type {Point}
        * @summary An instance of the Point class containing intersection coordinates.
        */
        get intersectionPoint(): Point;
    }
    /**
    * @class Contains the arguments passed to handlers of link validation events.
    * @augments LinkEventArgs
    */
    export class LinkValidationEventArgs extends LinkEventArgs {
        _node: any;
        _anchorIndex: any;
        _tableRow: any;
        /**
    ...
    import { NodeLabel } from "Diagramming/NodeLabel";
    ...
    */
    export class Events {
        ...
        */
        ...
        /**
        * A validation event raised while the user is moving or resizing multiple items. The event handlers get a SelectionEventArgs instance that contains data about this event.
        * @type {String}
        * @summary A string containing the event name.
        */
...
declare module "Diagramming/TextEditor" {
    export default TextEditor;
    class TextEditor {
        constructor(node: any, component: any);
        node: any;
        component: any;
        getTextToEdit(): any;
        getEditRect(point: any): any;
        createEditArgs(oldText: any, newText: any): ComponentEventArgs;
        setEditedText(newText: any): void;
        getDiagramItem(): any;
    }
    import { ComponentEventArgs } from "Diagramming/EventArgs";
}
declare module "Diagramming/DiagramBase" {
    /**
    * @class The base class of the Diagram and DiagramDocument classes.
    */
    export class DiagramBase extends Canvas {
        eventTarget: DiagramBase;
        raiseInitialize(item: any): void;
        onInitialize(item: any): void;
        /**
        ...
        */
        ...
        onCreated(item: any, point: any): void;
        raiseCreating(item: any, ist: any): Promise<boolean>;
        onCreating(item: any, ist: any): Promise<boolean>;
        raiseModifying(item: any, ist: any): Promise<boolean>;
        onModifying(item: any, ist: any): Promise<boolean>;
        raiseDeleting(item: any): Promise<boolean>;
        onDeleting(item: any): Promise<boolean>;
        /**
        ...
        */
        ...
        onModified(item: any, mousePosition: any, adjustmentHandle: any): void;
        raiseTreeExpanded(root: any): void;
        onTreeExpanded(root: any): void;
        raiseTreeCollapsed(root: any): void;
        onTreeCollapsed(root: any): void;
        raiseExpandButtonClicked(root: any, position: any, button: any): void;
        onExpandButtonClicked(root: any, position: any, button: any): void;
        /**
        * For internal use only.
        * @private
        */
        ...
        */
        ...
        onClicked(item: any, mousePosition: any, mouseButton: any): any;
        /**
        ...
        * @param {MouseButton} mouseButton The mouse button, with which the item has been clicked.
        */
        raiseDoubleClicked(item: DiagramItem, mousePosition: Point, mouseButton: MouseButton): void;
        onDoubleClicked(item: any, mousePosition: any, mouseButton: any): any;
        /**
        * Raises an event which notifies that a Diagram item will be selected.
        * @param {DiagramItem} item The Diagram item.
        */
        raiseSelecting(item: DiagramItem): Promise<boolean>;
        onSelecting(item: any): Promise<boolean>;
        /**
        ...
        */
        ...
        onSelectionChanged(oldItems: any, newItems: any): void;
        raiseHitTestAdjustmentHandles(item: any, mousePosition: any): number;
        onHitTestAdjustmentHandles(item: any, mousePosition: any): number;
        raiseDrawAdjustmentHandles(item: any, context: any): void;
        onDrawAdjustmentHandles(item: any, context: any): void;
        raiseMouseHover(item: any, mousePosition: any): void;
        onMouseHover(item: any, mousePosition: any): void;
        raiseSerializeTag(params: any): boolean;
        onSerializeTag(params: any): boolean;
        raiseDeserializeTag(params: any): boolean;
        onDeserializeTag(params: any): boolean;
        raiseTableColumnResizing(table: any, column: any, mousePosition: any, mouseButton: any, shouldCancel: any): Promise<boolean>;
        onTableColumnResizing(table: any, column: any, mousePosition: any, mouseButton: any, shouldCancel: any): Promise<boolean>;
        raiseTableColumnResized(table: any, column: any, mousePosition: any, mouseButton: any): void;
        onTableColumnResized(table: any, column: any, mousePosition: any, mouseButton: any): void;
        raiseTableRowResizing(table: any, row: any, mousePosition: any, mouseButton: any, shouldCancel: any): Promise<boolean>;
        onTableRowResizing(table: any, row: any, mousePosition: any, mouseButton: any, shouldCancel: any): Promise<boolean>;
        raiseTableRowResized(table: any, row: any, mousePosition: any, mouseButton: any): void;
        onTableRowResized(table: any, row: any, mousePosition: any, mouseButton: any): void;
        raiseHeaderResizing(header: any, horizontal: any): Promise<boolean>;
        onHeaderResizing(header: any, horizontal: any): Promise<boolean>;
        raiseHeaderResized(header: any, horizontal: any): void;
        onHeaderResized(header: any, horizontal: any): void;
        /**
        ...
        */
        ...
        onPasted(item: any): void;
        raiseAnimatedLayoutCompleted(item: any): void;
        onAnimatedLayoutCompleted(item: any): void;
        raiseValidateLinkCrossing(topLink: any, topSegmentIndex: any, bottomLink: any, bottomSegmentIndex: any, intersectionPoint: any): boolean;
        onValidateLinkCrossing(topLink: any, topSegmentIndex: any, bottomLink: any, bottomSegmentIndex: any, intersectionPoint: any): boolean;
        raiseValidateAnchorPoint(link: any, outgoing: any, node: any, pointIndex: any): boolean;
        onValidateAnchorPoint(link: any, outgoing: any, node: any, pointIndex: any): boolean;
        raiseContainerChildAdding(item: any, container: any): Promise<NodeEventArgs>;
        onContainerChildAdding(item: any, container: any): Promise<NodeEventArgs>;
        raiseContainerChildRemoving(item: any, container: any): Promise<boolean>;
        onContainerChildRemoving(item: any, container: any): Promise<boolean>;
        raiseContainerChildAdded(item: any, container: any): boolean;
        onContainerChildAdded(item: any, container: any): boolean;
        raiseContainerChildRemoved(item: any, container: any): boolean;
        onContainerChildRemoved(item: any, container: any): boolean;
        raiseContainerFolded(container: any): boolean;
        onContainerFolded(container: any): boolean;
        raiseContainerUnfolded(container: any): boolean;
        onContainerUnfolded(container: any): boolean;
        raiseNodeDomCreated(item: any): void;
        onNodeDomCreated(item: any): void;
        raiseNodeClicked(item: any, mousePosition: any, mouseButton: any): boolean;
        onNodeClicked(item: any, mousePosition: any, mouseButton: any): boolean;
        raiseNodeDoubleClicked(item: any, mousePosition: any, mouseButton: any): boolean;
        onNodeDoubleClicked(item: any, mousePosition: any, mouseButton: any): boolean;
        raiseLinkClicked(item: any, mousePosition: any, mouseButton: any): boolean;
        onLinkClicked(item: any, mousePosition: any, mouseButton: any): boolean;
        raiseLinkDoubleClicked(item: any, mousePosition: any, mouseButton: any): boolean;
        onLinkDoubleClicked(item: any, mousePosition: any, mouseButton: any): boolean;
        raiseHyperlinkClicked(hyperlink: any): void;
        onHyperlinkClicked(hyperlink: any): void;
        raiseTextEditing(editObject: any, text: any): Promise<boolean>;
        onTextEditing(editObject: any, text: any): Promise<boolean>;
        raiseTextEdited(lastIO: any, oldText: any, newText: any): void;
        onTextEdited(lastIO: any, oldText: any, newText: any): void;
        raiseItemAdded(item: any): void;
        onItemAdded(item: any): void;
        raiseItemRemoved(item: any): void;
        onItemRemoved(item: any): void;
        raiseQueryViews(): any[];
        onQueryViews(): any[];
        raiseDataLoaded(): void;
        onDataLoaded(): void;
        raiseRepaint(repaintArgs: any): void;
        onRepaint(repaintArgs: any): void;
        raiseSizeChanged(): void;
        onSizeChanged(): void;
        raiseLinkSplit(link: any, mousePosition: any): void;
        onLinkSplit(link: any, mousePosition: any): void;
    }
...
declare module "Diagramming/Factory" {
    ...
    */
    export class Factory {
        ...
        * @param {Number|TreeViewItem} [originRow] The zero-based index of the origin table row or the origin tree item of the new link.
        * @param {DiagramNode} [destination] The destination node.
        * @param {Number|TreeviewItem} [destRow] The zero-based index of the destination table row or the destination tree item of the new link.
        * @returns {DiagramLink} The newly created DiagramLink instance.
        */
        createDiagramLink(...args: any[]): DiagramLink;
    }
...
declare module "Diagramming/Diagram" {
    ...
    * @augments DiagramBase
    */
    export class Diagram extends DiagramBase {
        static registerXmlTypes(): void;
        /**
        * For internal use only.
        * @private
        */
        private static compareZ;
        /**
        ...
        * @type {Number}
        * @summary A number specifying the maximum distance.
        */
        ...
        */
        ...
        _allowSelfLoops: any;
        set allowSplitLinks(arg: boolean);
        /**
        * Gets or sets a value indicating whether link segments can be added and removed interactively.
        * @type {Boolean}
        * @summary true if interactive adding/removing of link segments is allowed, or false otherwise.
        */
        get allowSplitLinks(): boolean;
        _allowSplitLinks: any;
        _mergeThreshold: any;
        ...
        */
        ...
        fromJsonObject(obj: any): typeof CompositeNode;
        ...
        */
        ...
        /**
        * Saves custom properties to JSON.
        * @private
        */
        private saveProps;
        /**
        * Loads custom properties from JSON.
        * @private
        */
        private loadProps;
        ...
        */
        ...
        fromXmlElement(doc: any, context: any): void;
        _style: any;
        /**
        ...
        */
        ...
        toXmlElement(diagramElement: any, context: any): void;
        loadProperties(elementName: any, parentElement: any, context: any): any;
        ...
        */
        ...
        linkText: any;
        shapeText: any;
        saveProperties(elementName: any, parentElement: any, context: any): any;
        ...
        * @private
        */
        private onItemAddedInternal;
        /**
        * CollectionChanged event handler.
        * For internal use only.
        * @private
        */
        private onItemRemovedInternal;
        onItemDropped(item: any, point: any): void;
        onItemDragging(item: any, point: any): Promise<boolean>;
        onDragOverNode(node: any, relatedItem: any): Promise<any>;
        onDropOverNode(node: any, relatedItem: any): any;
        visitNodes(point: any, nodeOp: any, relatedItem: any): Promise<boolean>;
        ...
        */
        ...
        mergePoints(point1: any, point2: any): boolean;
        updateCanUndo(): void;
        canUndo: boolean;
        canRedo: boolean;
        /**
    ...
    import { DiagramBase } from "Diagramming/DiagramBase";
    ...
    import { DiagramNode } from "Diagramming/LoadOrder";
    import { DiagramLink } from "Diagramming/LoadOrder";
    import { CompositeNode } from "Diagramming/LoadOrder";
    import { Style } from "Diagramming/Style";
    import { Theme } from "Diagramming/Theme";
    ...
    */
    export class Style {
        ...
        */
        ...
        set strokeDashArray(arg: any[]);
        /**
        * Gets or sets the line dash array applied when stroking outlines of diagram items.
        * @type {Array}
        * @summary An array of numbers, specifying the dash pattern.
        */
        get strokeDashArray(): any[];
        set strokeDashOffset(arg: number);
        /**
        * Gets or sets the offset ot the dash pattern applied when stroking outlines of diagram items.
        * @type {Number}
        * @summary A number, specifying the offset.
        */
        ...
        */
        ...
        hasStrokeDashArray(): number;
        _strokeDashOffset: number;
        hasStrokeDashOffset(): boolean;
        _textColor: string;
...
declare module "Diagramming/Theme" {
    ...
    */
    export class Theme {
        ...
        * @param {String} id The theme identificator.
        * @returns {Theme} An instance of the Theme class.
        */
        static fromId(id: string): Theme;
        _styles: Map<any, any>;
        /**
...
declare module "Diagramming/DiagramItem" {
    ...
    */
    class DiagramItem {
        ...
        * @param {String} text The label's text.
        * @returns {ItemLabel} An ItemLabel instance.
        */
        addLabel(text: string): any;
        /**
        * Removes the specified label from this item.
        * @param {ItemLabel} label An ItemLabel instance.
        */
        removeLabel(label: any): void;
        labelFromPoint(point: any): any;
        addLabelVisuals(): void;
        /**
        * Animates the item.
        * @param {ItemAnimation} animation An ItemAnimation -derived object.
        */
        animate(animation: any): void;
        /** @private */
        set parent(arg: any);
        /**
        ...
        * @returns {DiagramItemState} A DiagramItemState instance.
        * @virtual
        */
        ...
        */
        ...
        modifiedByController(controller: any): boolean;
        hitTestManipulators(mousePosition: any): any;
        getObjectToEdit(point: any, element: any): any;
        ...
        * @type {Number}
        * @summary A value between 0 and 1 specifying the item's opacity.
        */
        get opacity(): number;
        /**
        ...
        * @type {Array}
        * @summary An array of numbers specifying the item's stroke dash array.
        */
        get effectiveStrokeDashArray(): any[];
        /**
        * Gets the effective line dash offset that should be applied when stroking this item.
        * @type {Number}
        * @summary A number specifying the item's stroke dash offset.
        */
        get effectiveStrokeDashOffset(): number;
        /**
...
declare module "Diagramming/Selection" {
    ...
    */
    class Selection extends DiagramItem {
        ...
        * @param {DiagramView} [zoomTarget] The diagram view zoomed by lasso tool.
        */
        constructor(parent: any, zoomTarget?: any);
        _items: any[];
        _nodes: any[];
        _links: any[];
        ...
        * @param {DiagramItem} item The item to add.
        */
        addItem(item: DiagramItem): Promise<void>;
        /**
        * For internal use only.
        * @private
        */
...
declare module "Diagramming/DiagramNode" {
    ...
    */
    class DiagramNode extends DiagramItem {
        ...
        */
        raiseClicked(mousePosition: Point, mouseButton: MouseButton): any;
        /**
        * Raises an event which notifies that a node has been double-clicked.
        * @param {Point} mousePosition The position of the mouse.
        * @param {MouseButton} mouseButton A value identifying the clicked mouse button.
        */
        raiseDoubleClicked(mousePosition: Point, mouseButton: MouseButton): any;
        raiseValidateAnchorPoint(link: any, outgoing: any, pointIndex: any): any;
        /**
        ...
        */
        private deleteLinks;
        updateDragFromRect(rect: any): void;
        ...
        */
        ...
        onUpdateBounds(): void;
        get animatedBounds(): Rect;
        get effectiveBounds(): Rect;
        /**
        * For internal use only.
        * @private
        */
        ...
        */
        ...
        get labelType(): typeof NodeLabel;
...
declare module "Diagramming/ContainerNode" {
    ...
    */
    class ContainerNode extends DiagramNode {
        ...
        */
        visitNodes(point: any, visitNode: Function, relatedItem: any): Promise<any>;
        ...
        */
        ...
        raiseChildAdded(child: any): any;
        raiseChildRemoved(child: any): any;
        raiseFolded(): any;
        raiseUnfolded(): any;
        getChildLinks(): any[];
    ...
    */
    class DiagramLink extends DiagramItem {
        ...
        */
        ...
        set intermediateShape(arg: string | Shape);
        /**
        * Gets or sets the arrowhead shape displayed at the middle of each segment of the link.
        * @type {Shape | String}
        * @summary A Shape instance that represents an arrowhead shape.
        */
        get intermediateShape(): string | Shape;
        set intermediateBrush(arg: any);
        /**
        * Gets or sets an object that specifies how to fill intermediate link shapes.
        * @type {Object}
        * @summary A color string or an object literal specifying gradient.
        */
        get intermediateBrush(): any;
        _dynamic: any;
        ...
        */
        ...
        splitSegment(handle: any, pt: any): any;
        ...
        */
        ...
        drawArrowHead(content: any, p1: any, p2: any, shape: any, bounds: any, brush: any): void;
        drawHandles(context: any, handlesStyle: any): void;
        _baseShape: any;
        _baseShapeSize: any;
        _headShape: any;
        _headShapeSize: any;
        _intermediateShape: any;
        _intermediateShapeSize: any;
        get effectiveBaseBrush(): any;
        get effectiveHeadBrush(): any;
        intermediateShapeRenderer: ShapeRenderer;
        get effectiveIntermediateBrush(): any;
        ...
        * @private
        */
        private get cascadeEndHorizontal();
        /**
        ...
        */
        ...
        get labelType(): typeof LinkLabel;
    ...
    class BezierShape {
        ...
        */
        ...
        static mergeLinkSegments(link: any, handleIndex: any): boolean;
        static splitLinkSegment(link: any, segment: any, point: any): number;
        static addIntermediateShapes(link: any, content: any): void;
    }
    class PolylineShape {
        /**
        * For internal use only.
        ...
        */
        static containsPoint(link: any, point: Point, maxDist: any, refSegment: any): boolean;
        /**
        * For internal use only.
        * @private
        */
        ...
        */
        ...
        static resetSelfLoopPoints(link: any, allowChangeSegments: any): void;
        static mergeLinkSegments(link: any, handleIndex: any): boolean;
        static splitLinkSegment(link: any, segment: any, point: any): any;
        static addIntermediateShapes(link: any, content: any): void;
    }
    ...
    class SplineShape {
        ...
        */
        ...
        static splitLinkSegment(link: any, segment: any, point: any): any;
        static addIntermediateShapes(link: any, content: any): void;
        static findMatch(approximation: any, point: any, startIndex: any, maxDist: any): any;
    }
    import { DiagramNode } from "Diagramming/LoadOrder";
    import { Rect } from "@mindfusion/drawing";
    import ShapeRenderer from "Diagramming/ShapeRenderer";
    ...
    */
    class SinglePointerController {
        ...
        */
        ...
        overrideTarget(): any;
        get requiresDiagramCoords(): boolean;
    }
    import { Point } from "@mindfusion/drawing";
}
    ...
    */
    export class BehaviorBase {
        ...
        */
        ...
        findInteractionTarget(position: any): any;
        shouldSplitLink(link: any, point: any, refSegment: any): boolean;
    }
}
declare module "Diagramming/DiagramPage" {
    /**
    * @class Represents a single page in a DiagramDocument object.
    * @augments Diagram
    */
    export class DiagramPage extends Diagram {
        /**
        ...
        * @type {String}
        * @summary A string specifying the page title.
        */
        get title(): string;
        set titleColor(arg: string);
        /**
...
declare module "Diagramming/DiagramDocument" {
    /**
    * @class Represents a collection of diagram pages.
    * @augments DiagramBase
    */
    export class DiagramDocument extends DiagramBase {
        _pages: any[];
        /**
        * Gets a list of the diagram pages contained in this document.
        * @type {Array}
        * @summary Array of DiagramPage objects.
        * @remarks Use the addPage/removePage methods for adding and removing pages.
        */
        get pages(): any[];
        /**
        * Adds a page to the document.
        * @param {DiagramPage} page The page to add.
        */
        addPage(page: DiagramPage): void;
        /**
        * Removes the specified page from the document.
        * @param {DiagramPage} page The page to be removed.
        */
        removePage(page: DiagramPage): void;
        /**
        * Serializes the document into a JSON string.
        * @returns {String} A string containing the document's JSON representation.
        */
        toJson(): string;
        toJsonObject(): {
            diagrams: any[];
        ...
        * @type {Boolean}
        * @summary true if the document has changed, or false otherwise.
        */
        get dirty(): boolean;
        /**
        ...
        * @param {String} url A URL specifying where the document's XML should be posted to.
        */
        saveToXml(url: string): void;
        /**
        * Loads document contents from specified XML or JSON string.
        * @param {String} str A string containing the serialized document contents.
        */
        loadFromString(str: string): void;
        /**
        * Encodes the document contents into an XML or JSON string.
        * @param {SaveToStringFormat} format A member of the SaveToStringFormat enumeration.
        * @returns {String} A string containing the document's serialized representation.
        */
        saveToString(format: SaveToStringFormat): string;
        /**
        * Loads document contents from specified XML Document.
        * @param {Document} document A DOM Document object containing XML-serialized DiagramDocument contents.
        */
        fromXmlDocument(document: Document): void;
        /**
        * Saves the document into an XML Document.
        * @returns {Document} A DOM Document object containing XML-serialized DiagramDocument contents.
        */
        toXmlDocument(): Document;
        _dirty: boolean;
        setDirty(value: any): void;
    ...
    import { DiagramBase } from "Diagramming/DiagramBase";
    import { DiagramPage } from "Diagramming/DiagramPage";
    import { SaveToStringFormat } from "Diagramming/Enum";
}
...
declare module "Diagramming/Interaction/MouseEventHandler" {
    ...
    class MouseEventHandler {
        ...
        canvasElement: any;
        inputDispatcher: any;
        mouseDownDelegate: (e: any) => void;
        mouseMoveDelegate: (e: any) => void;
        mouseUpDelegate: (e: any) => void;
        mouseWheelDelegate: (e: any) => void;
        attachHandlers(): void;
        detachHandlers(): void;
...
declare module "Diagramming/Interaction/TouchEventHandler" {
    ...
    class TouchEventHandler {
        ...
        canvasElement: any;
        inputDispatcher: any;
        touchStartDelegate: (e: any) => void;
        touchMoveDelegate: (e: any) => void;
        touchEndDelegate: (e: any) => void;
        attachHandlers(): void;
        detachHandlers(): void;
        emulateMouse(e: any): {
            button: number;
...
declare module "Diagramming/Interaction/PointerEventHandler" {
    ...
    class PointerEventHandler {
        ...
        canvasElement: any;
        inputDispatcher: any;
        pointerDownDelegate: (e: any) => void;
        pointerMoveDelegate: (e: any) => void;
        pointerUpDelegate: (e: any) => void;
        pointerCancelDelegate: (e: any) => void;
        lostCaptureDelegate: (e: any) => void;
        mouseWheelDelegate: (e: any) => void;
        attachHandlers(): void;
        detachHandlers(): void;
        ...
        onLostCapture(e: any): void;
        handlePointerReleased(e: any, accept: any): void;
        updateTouchThreshold(e: any): void;
        onMouseWheel(e: any): void;
    }
}
...
declare module "Diagramming/Interaction/MouseInputDispatcher" {
    ...
    */
    export class MouseInputDispatcher {
        ...
        * @param {Point} position A point specified in diagram coordinates.
        */
        onMouseMove(position: any): Promise<void>;
        pointedItem: any;
        ...
        * @param {Number} button 0 for left button, 1 for middle button, 2 for right button.
        */
        onMouseUp(position: any, button: number): Promise<void>;
        onDoubleClick(position: any, button: any): Promise<void>;
        selectController(): any;
        getPointedItem(): any;
        anyController(predicate: any): any;
        forEachController(fun: any): void;
        cancelAllInteractions(): void;
    }
}
declare module "Diagramming/Interaction/DualPointerController" {
    export default DualPointerController;
    /**
    * @class Processes dual-touch events targeting a diagram element.
    */
    class DualPointerController {
        /**
        * Initializes a new instance of the DualPointerController class.
        * @constructor
        * @param {DiagramItem} modifiedItem The item that will be modified by this controller.
        */
        constructor(modifiedItem: DiagramItem);
        modifiedItem: DiagramItem;
        action: number;
        originalStates: Map<any, any>;
        /**
        * Called when the user starts drawing or modifying a diagram element.
        * @param {Point} position A point specified in diagram coordinates.
        */
        start(position1: any, position2: any): void;
        modifiedDiagram: any;
        /**
        * Called continuously while the user draws with the mouse or touch.
        * @param {Point} position A point specified in diagram coordinates.
        */
        move(position1: any, position2: any): void;
        /**
        * Called to validate the operation at current pointer position.
        * @param {Point} position A point specified in diagram coordinates.
        * @returns {Boolean} true to accept the operation, or false otherwise.
        */
        validate(position1: any, position2: any): boolean;
        /**
        * Called when the user stops drawing or modifying a diagram element, accepting the operation.
        * @param {Point} position A point specified in diagram coordinates.
        */
        commit(position1: any, position2: any): void;
        /**
        * Called when the user stops drawing or modifying a diagram element, rejecting the operation.
        * @param {Point} position A point specified in diagram coordinates.
        */
        cancel(position1: any, position2: any): void;
        cancelNow(): void;
        cancelDrag: boolean;
        shouldCancelDrag(): boolean;
        /**
...
declare module "Diagramming/Interaction/DualPointerNodeController" {
    /**
    * @class A controller used to modify existing nodes in the diagram.
    * @augments DualPointerController
    */
    export class DualPointerNodeController extends DualPointerController {
        /**
        * Initializes a new instance of the DualPointerNodeController class.
        * @constructor
        * @param {DiagramNode} node The node that will be modified by this controller.
        */
        constructor(node: any);
        node: any;
        startBounds: any;
    ...
    import DualPointerController from "Diagramming/Interaction/DualPointerController";
    import DiagramMediator from "Diagramming/Interaction/DiagramMediator";
    import { Point } from "@mindfusion/drawing";
}
declare module "Diagramming/Interaction/DualPointerViewController" {
    /**
    * @class A controller used to modify existing nodes in the diagram.
    * @augments DualPointerController
    */
    export class DualPointerViewController extends DualPointerController {
        /**
        * Initializes a new instance of the DualPointerViewController class.
        * @constructor
        * @param {DiagramView} view The view that will be modified by this controller.
        */
        constructor(view: any);
        view: any;
        startZoom: any;
...
declare module "Diagramming/Interaction/PointerInputDispatcher" {
    /**
    * @class Processes pointer events and dispatches them to controller objects appropriate for current context.
    */
    export class PointerInputDispatcher {
        /**
        * Initializes a new instance of the PointerInputDispatcher class.
        * @constructor
        * @param {DiagramView} diagramView The DiagramView instance that should receive pointer input.
        */
        constructor(diagramView: DiagramView);
        diagramView: DiagramView;
        buttonDown: number;
        interactions: any[];
        get diagram(): import("Diagramming/Diagram").Diagram;
        interactionByPointerId(pointerId: any): any;
        interactionByTarget(target: any): any;
        retargetedInteraction(originalTarget: any): any;
        /**
        * Called when the user presses down a mouse button or touches the screen.
        * @param {Point} position A point specified in diagram coordinates.
        * @param {Number} button 0 for left button, 1 for middle button, 2 for right button.
        */
        onPointerDown(position: Point, button: number, id: any): void;
        ...
        buttonDownPosition: Point;
        /**
        * Called when the user moves the mouse or touch.
        * @param {Point} position A point specified in diagram coordinates.
        */
        onPointerMove(position: Point, id: any): Promise<void>;
        pointedItem: any;
        /**
        * Called when the user releases a mouse button or touch.
        * @param {Point} position A point specified in diagram coordinates.
        * @param {Number} button 0 for left button, 1 for middle button, 2 for right button.
        */
        onPointerUp(position: Point, button: number, id: any): Promise<void>;
        currentController: InplaceEditController;
        /**
        * Called when the system cancels pointer interaction.
        * @param {Point} position A point specified in diagram coordinates.
        * @param {Number} button 0 for left button, 1 for middle button, 2 for right button.
        */
        onPointerCancel(position: Point, button: number, id: any): void;
        onDoubleClick(position: any, button: any): Promise<void>;
        selectController(interaction: any): any;
        findInteractionTarget(position: any): any;
        anyController(predicate: any): boolean;
        forEachController(fun: any): void;
        cancelAllInteractions(): void;
    }
    import { DiagramView } from "Diagramming/DiagramView";
    import { Point } from "@mindfusion/drawing";
    import InplaceEditController from "Diagramming/Interaction/InplaceEditController";
}
declare module "Diagramming/Interaction/KeyboardInputDispatcher" {
    ...
    class KeyboardInputDispatcher {
        ...
        inputState: {};
        get diagram(): any;
        onKeyUp(target: any, keyCode: any, recorded: any, value: any): Promise<void>;
    }
}
...
declare module "Diagramming/PanBehavior" {
    ...
    */
    export class PanBehavior extends BehaviorBase {
        ...
        * @param {DiagramView} parent The DiagramView this behavior will be associated with.
        */
        constructor(parent: any, supportsModify: any);
        _supportsModify: any;
    }
    import { BehaviorBase } from "Diagramming/BehaviorBase";
}
declare module "Diagramming/ZoomBehavior" {
    /**
    * @class Zooms the diagram when the users drags the mouse.
    * @augments BehaviorBase
    */
    export class ZoomBehavior extends BehaviorBase {
        /**
...
declare module "Diagramming/Interaction/MoveLabelsController" {
    export default MoveLabelsController;
    class MoveLabelsController extends SinglePointerController {
        constructor(diagram: any, label: any);
        diagram: any;
        label: any;
    }
    import SinglePointerController from "Diagramming/Interaction/SinglePointerController";
}
declare module "Diagramming/MoveLabelsBehavior" {
    /**
    * @class This class is used when the diagram behavior is set to Behavior.MoveLabels.
    * @augments BehaviorBase
    */
    export class MoveLabelsBehavior extends BehaviorBase {
    }
    import { BehaviorBase } from "Diagramming/BehaviorBase";
}
declare module "Diagramming/DiagramView" {
    ...
    */
    export class DiagramView extends CanvasControl {
        ...
        * @param {DiagramBase} [diagram] The Diagram instance this control is associated with.
        * @returns {DiagramView} The newly created DiagramView object.
        */
        static create(element: HTMLCanvasElement, diagram?: any): DiagramView;
        /**
        ...
        */
        ...
        queryViewDelegate: (sender: any, args: any) => void;
        lastMouseUp: Date;
        doubleClick: boolean;
        ...
        */
        ...
        _multiTouchZoom: boolean;
        _multiTouchModify: boolean;
        _multiTouchDraw: boolean;
        _enableMultiTouch: boolean;
        _handleTouchHitDistance: number;
        ...
        */
        ...
        set enableMultiTouch(arg: boolean);
        /**
        * Gets or sets a value indicating whether the control handles DOM pointer events
        * to implement multi-touch interactions, such as zooming, node rotation or
        * simultaneous drawing of multiple diagram items.
        * @type {Boolean}
        * @summary true to enable multi-touch, or false otherwise. The default value is true.
        */
        get enableMultiTouch(): boolean;
        ...
        */
        ...
        set multiTouchZoom(arg: boolean);
        /**
        * Gets or sets a value indicating whether multi-touch zoom is enabled.
        * @type {Boolean}
        * @summary true to enable multi-touch zoom, or false otherwise. The default value is true.
        */
        get multiTouchZoom(): boolean;
        set multiTouchModify(arg: boolean);
        /**
        * Gets or sets a value indicating whether multi-touch modifications are enabled.
        * @type {Boolean}
        * @summary true to enable multi-touch node modification, or false otherwise. The default value is true.
        */
        get multiTouchModify(): boolean;
        set multiTouchDraw(arg: boolean);
        /**
        * Gets or sets a value indicating whether the control allows drawing multiple items simultaneously.
        * @type {Boolean}
        * @summary true to allow drawing multiple items simultaneously, or false otherwise. The default value is true.
        */
        get multiTouchDraw(): boolean;
        ...
        */
        ...
        onClick(position: any, button: any): Promise<void>;
        onTooltip(): void;
        onMagnify(): void;
        ...
        */
        ...
        doPaste(json: any, offsetX: any, offsetY: any, unconnectedLinks: any): Promise<void>;
        /**
        * Cuts the currently selected items to the clipboard.
        * @param {Boolean} [systemClipboard] true to copy to the system clipboard, or false otherwise. The default value is false.
        */
        cutToClipboard(systemClipboard?: boolean): Promise<void>;
        /**
        ...
        * @param {ViewAnimation} animation A ViewAnimation-derived object.
        */
        animate(animation: any): void;
        _behavior: any;
        currentBehavior: LinkNodesBehavior | ModifyBehavior | DoNothingBehavior | DrawLinksBehavior | DrawNodesBehavior | PanBehavior | SelectOnlyBehavior | MagnifyBehavior | MoveNodesBehavior | MoveLabelsBehavior | ZoomBehavior;
        /**
        ...
        */
        ...
        mouseInputDispatcher: any;
        set handleTouchHitDistance(arg: number);
        /**
        * Gets or sets maximum distance between touch position and adjustment
        * handle at which the handle can still be grabbed to modify its item.
        * @type {Number}
        * @summary A number specifying the allowed hit distance, in diagram's current unit. The default value is 5.
        */
        get handleTouchHitDistance(): number;
        /**
    ...
    */
        ...
        */
        loadFromXml(fileUrl: string, onLoad?: Function, onError?: Function): void;
        loadView(elementName: any, parentElement: any, context: any): any;
        /**
        * Saves the diagram to an XML file.
        * @param {String} url A URL specifying where the diagram's XML should be posted to.
        */
    ...
    import { MoveLabelsBehavior } from "Diagramming/MoveLabelsBehavior";
    import { ZoomBehavior } from "Diagramming/ZoomBehavior";
    import PointerEventHandler from "Diagramming/Interaction/PointerEventHandler";
    ...
    */
    export class NodeListView extends CanvasControl {
        ...
        */
        ...
        /**
        * Removes a node from the NodeListView.
        * @param {DiagramNode} node The node to remove.
        */
    ...
    */
    export class Overview extends CanvasControl {
        ...
        */
        ...
        diagramChangedDelegate: (sender: any, args: any) => void;
...
declare module "Diagramming/ArrowHeads" {
    /**
    * @class Provides acccess to predefined arrowhead shapes.
    */
    export class ArrowHeads {
        /**
        * Do not display an arrow shape.
        * @returns {Shape} null.
        */
        static None(): Shape;
        /**
...
declare module "Diagramming/Animations/ItemAnimation" {
    /**
    * @class Base class of diagram item animations.
    * @augments Animation
    */
    export class ItemAnimation extends Animation {
        /**
        ...
        */
        ...
        colorValue(animationDelta: any): any;
    }
    import { Animation } from "@mindfusion/animations";
}
declare module "Diagramming/Animations/BounceAnimation" {
    /**
    * @class Animates vertical position of nodes.
    * @augments ItemAnimation
    */
    export class BounceAnimation extends ItemAnimation {
        repaint(): void;
    }
    import { ItemAnimation } from "Diagramming/Animations/ItemAnimation";
}
declare module "Diagramming/Animations/FillColorAnimation" {
    /**
    * @class Animates the fill color of nodes or link arrowheads.
    * @augments ItemAnimation
    */
    export class FillColorAnimation extends ItemAnimation {
    }
    import { ItemAnimation } from "Diagramming/Animations/ItemAnimation";
}
declare module "Diagramming/Animations/OpacityAnimation" {
    /**
    * @class Animates items' opacity for fade-in and fade-out effects.
    * @augments ItemAnimation
    */
    export class OpacityAnimation extends ItemAnimation {
    }
    import { ItemAnimation } from "Diagramming/Animations/ItemAnimation";
}
declare module "Diagramming/Animations/PathAnimation" {
    /**
    * @class Animates node positions along specified path.
    * @augments ItemAnimation
    */
    export class PathAnimation extends ItemAnimation {
...
declare module "Diagramming/Animations/PulseAnimation" {
    /**
    * @class Animates node's local scale factor.
    * @augments ItemAnimation
    */
    export class PulseAnimation extends ItemAnimation {
        repaint(): void;
    }
    import { ItemAnimation } from "Diagramming/Animations/ItemAnimation";
}
declare module "Diagramming/Animations/ShakeAnimation" {
    /**
    * @class Animates horizontal position of nodes.
    * @augments ItemAnimation
    */
    export class ShakeAnimation extends ItemAnimation {
        repaint(): void;
    }
    import { ItemAnimation } from "Diagramming/Animations/ItemAnimation";
}
declare module "Diagramming/Animations/StrokeColorAnimation" {
    /**
    * @class Animates the color of node borders or link segments.
    * @augments ItemAnimation
    */
    export class StrokeColorAnimation extends ItemAnimation {
    }
    import { ItemAnimation } from "Diagramming/Animations/ItemAnimation";
}
declare module "Diagramming/Animations/ViewAnimation" {
    /**
    * @class Base class of diagram view animations.
    * @augments Animation
    */
    export class ViewAnimation extends Animation {
        /**
        * Initializes a new instance of the ItemAnimation class.
        * @constructor
        * @param {Object} [options] An object used to specify various property values for the animation.
        */
        constructor(options?: any);
        pointValue(animationDelta: any): Point;
    }
    import { Animation } from "@mindfusion/animations";
    import { Point } from "@mindfusion/drawing";
}
declare module "Diagramming/Animations/ScrollAnimation" {
    /**
    * @class Animates the scroll position of a diagram view.
    * @augments ViewAnimation
    */
    export class ScrollAnimation extends ViewAnimation {
    }
    import { ViewAnimation } from "Diagramming/Animations/ViewAnimation";
}
declare module "Diagramming/Animations/ZoomAnimation" {
    /**
    * @class Animates the zoom level of a diagram view.
    * @augments ViewAnimation
    */
    export class ZoomAnimation extends ViewAnimation {
    }
    import { ViewAnimation } from "Diagramming/Animations/ViewAnimation";
}
declare module "Diagramming/Animations" {
    export namespace Animations {
        export { ItemAnimation };
        export { BounceAnimation };
        export { FillColorAnimation };
        export { OpacityAnimation };
        export { PathAnimation };
        export { PulseAnimation };
        export { ShakeAnimation };
        export { StrokeColorAnimation };
        export { ViewAnimation };
        export { ScrollAnimation };
        export { ZoomAnimation };
    }
    import { ItemAnimation } from "Diagramming/Animations/ItemAnimation";
    import { BounceAnimation } from "Diagramming/Animations/BounceAnimation";
    import { FillColorAnimation } from "Diagramming/Animations/FillColorAnimation";
    import { OpacityAnimation } from "Diagramming/Animations/OpacityAnimation";
    import { PathAnimation } from "Diagramming/Animations/PathAnimation";
    import { PulseAnimation } from "Diagramming/Animations/PulseAnimation";
    import { ShakeAnimation } from "Diagramming/Animations/ShakeAnimation";
    import { StrokeColorAnimation } from "Diagramming/Animations/StrokeColorAnimation";
    import { ViewAnimation } from "Diagramming/Animations/ViewAnimation";
    import { ScrollAnimation } from "Diagramming/Animations/ScrollAnimation";
    import { ZoomAnimation } from "Diagramming/Animations/ZoomAnimation";
}
declare module "@mindfusion/diagramming" {
    ...
    export { DiagramBase } from "Diagramming/DiagramBase";
    export { DiagramDocument } from "Diagramming/DiagramDocument";
    export { DiagramPage } from "Diagramming/DiagramPage";
    ...
    export { LengthType, Cursors, ImageAlign, Alignment, CellFrameStyle, AdjustmentHandles, Behavior, Action, ConnectionStyle, MarkStyle, ShadowsStyle, ShowAnchors, GridStyle, ColumnStyle, LinkShape, RelativeToLink, FitSize, EffectPhase, GlassEffectType, HandlesStyle, LinkCrossings, ModificationStart, AutoResize, ModifierKeyAction, MouseButtonActions, LinkTextStyle, SimpleShape, Orientation, SaveToStringFormat, ScaleMode, ExpandButtonAction, DelKeyAction, MouseWheelAction } from "Diagramming/Enum";
    export { ItemEventArgs, LinkEventArgs, NodeEventArgs, CellEventArgs, ComponentEventArgs, SelectionEventArgs, SerializeTagEventArgs, DiagramEventArgs, InplaceEditEventArgs, HeaderEventArgs, HeaderResizeEventArgs, TreeItemEventArgs, SelectionChangedEventArgs, LinkValidationEventArgs, LinkCrossingEventArgs } from "Diagramming/EventArgs";
    ...
    export { ItemLabel } from "Diagramming/ItemLabel";
    export { LinkLabel } from "Diagramming/LinkLabel";
    export { NodeLabel } from "Diagramming/NodeLabel";
    ...
    export { ArrowHeads } from "Diagramming/ArrowHeads";
    ...
    export { Animations } from "Diagramming/Animations";
}
