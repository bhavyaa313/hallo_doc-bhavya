...
declare module "Common/UI/Enum" {
    ...
    /**
     * Specifies how tabs scrolling is performed.
     */
    export type TabsScrollMode = number;
    export namespace TabsScrollMode {
        const None_3: number;
        export { None_3 as None };
        export const ScrollButtons: number;
        export const NavButtons: number;
    }
}
...
declare module "Common/UI/ToolStrip" {
    ...
    export class ToolStrip extends ListContainer {
        ...
        */
        expand(): void;
        getGroupBounds(group: any): Rect;
        isInView(item: any): boolean;
        ...
        */
        ...
        scrollMaxed(): boolean;
        resetGroups(): void;
        getGroupItems(item: any): import("@mindfusion/common-collections").IEnumerable<any>;
        /**
    ...
    */
    export class Picker extends UIControl {
       ...
       */
        ...
        static applyStyles(shadow: any): void;
        _defaultWidth: Unit;
        _defaultHeight: Unit;
        _dropdownWidth: Unit;
...
declare module "Common/UI/Dialogs" {
    ...
    */
    export class Dialogs {
        ...
        * @param {Object} [items] The object containing the items data.
        * @param {Point} [position] A Point instance representing x and y coorinates of the menu position.
        * @param {Function} [callback] The callback function to invoke when the menu is closed.
        * The first parameter of the callback function contains a reference to the clicked item.
        * @param {HTMLElement} [parentElement] The Dom element to append the menu to.
        * If the parameter is not specified, the dialog will be appended to document.body.
        * @param {String} [theme] The theme of the menu.
        * @param {Object} [context] Contains custom parameteres passed to the callback function.
        */
        static showContextMenu(items?: any, position?: any, callback?: Function, parentElement?: HTMLElement, theme?: string, context?: any): Menu;
    }
...
declare module "Common/UI/TabStrip" {
    ...
    */
    export class TabStrip extends ToolStrip {
        _closeButtonClick: EventDispatcher<import("Controls/EventArgs").EventArgs>;
        _addButtonClick: EventDispatcher<import("Controls/EventArgs").EventArgs>;
        _navButtonClick: EventDispatcher<import("Controls/EventArgs").EventArgs>;
        _scrollMode: number;
        _autoSizeTabs: boolean;
        _showCloseButtons: boolean;
        ...
        */
        private autoSize;
        resetButtons(): void;
        set tabMaxSize(arg: Unit);
        /**
        * Gets or sets the maximum size of the tabs.
        * @type {Unit}
        * @summary The maximum size of tabs when autoSizeTabs is on.
        */
        get tabMaxSize(): Unit;
        _tabMaxSize: any;
        set scrollMode(arg: number);
        /**
        * Gets or sets a value indicating how tab scrolling is performed.
        * @type {TabsScrollMode}
        * @summary A member of the TabsScrollMode enumeration.
        */
        get scrollMode(): number;
        private set autoSizeTabs(arg);
        /**
        * Gets or sets a value indicating whether to auto-size tabs so they fit in the header area.
        * @type {Boolean}
        * @summary true to auto-size tabs, or false otherwise. The default value is false.
        * @private
        */
        private get autoSizeTabs();
        set showCloseButtons(arg: boolean);
        /**
        * Gets or sets a value indicating whether to display a close button for each tab.
        * @type {Boolean}
        * @summary true if the tabs close buttons are visible, or false otherwise. The default value is false.
        */
        get showCloseButtons(): boolean;
        set showAddButton(arg: boolean);
        /**
        * Gets or sets a value indicating whether to display an 'Add tab' button.
        * @type {Boolean}
        * @summary true to display an 'Add tab' button, or false otherwise. The default value is false.
        */
        get showAddButton(): boolean;
        /**
       * Raised when a tab's close button is clicked.
       * @event closeButtonClick
       * @type {EventDispatcher}
       * @property {TabStrip} sender
       * @property {ItemEventArgs} args
       */
        get closeButtonClick(): EventDispatcher<any>;
        /**
       * Raised when the 'Add tab' button is clicked.
       * @event addButtonClick
       * @type {EventDispatcher}
       * @property {TabStrip} sender
       * @property {ItemEventArgs} args
       */
        get addButtonClick(): EventDispatcher<any>;
        /**
       * Raised when a navigation button is clicked.
       * @event navButtonClick
       * @type {EventDispatcher}
       * @property {TabStrip} sender
       * @property {ItemEventArgs} args
       */
        get navButtonClick(): EventDispatcher<any>;
    }
    import { ToolStrip } from "Common/UI/ToolStrip";
    import { EventDispatcher } from "@mindfusion/common";
    import { Unit } from "@mindfusion/common";
