...
declare module "Graphs/TreeHelper" {
    export default class TreeHelper {
        constructor(reversedLinks: any);
        reversedLinks: any;
        parentNode(edge: any): any;
        childNode(edge: any): any;
        parentEdges(vertex: any): any;
        childEdges(vertex: any): any;
        assignPoints(edge: any, points: any): void;
    }
}
declare module "Graphs/Graph" {
    ...
    */
    export class Graph {
        ...
        */
        tree(root: Vertex, reversedLinks: any, enableAssistants: boolean, compactAssistants: boolean): Graph;
        collectLevels(parent: any): void;
        /**
        * @private
        */
        private childrenOf;
...
declare module "Graphs/BorderedTreeLayout" {
    ...
    */
    export class BorderedTreeLayout extends Layout {
        ...
        */
        get linkType(): number;
        set reversedLinks(arg: boolean);
        /**
        * Gets or sets a value indicating the link direction that relates parent nodes to child nodes.
        * @type {Boolean}
        * @summary true to indicate reversed direction (links point to parent nodes), or false otherwise.
        */
        get reversedLinks(): boolean;
        /**
        ...
        */
        ...
        _direction: number;
        _linkType: number;
        _reversedLinks: boolean;
    }
    import { Layout } from "Graphs/Layout";
    import TreeHelper from "Graphs/TreeHelper";
}
...
declare module "Graphs/RadialTreeLayout" {
    /**
    * @class Implements a radial tree layout algorithm.
    * @augments Layout
    */
    export class RadialTreeLayout extends Layout {
        set levelDistance(arg: number);
        /**
        * Gets or sets the space to leave between adjacent levels of the tree.
        * @type {Number}
        ...
        */
        get direction(): number;
        set stretchFactor(arg: number);
        /**
        * Gets or sets the stretch factor in radial layouts.
        * @type {Number}
        * @summary The stretch factor.
        */
        ...
        */
        ...
        treeHelper: TreeHelper;
        tree: any;
        arrangeLevel(parentLevel: any): any;
        calcBounds(): any;
        calcRadius(level: any): any;
        getType(): any;
        _levelDistance: number;
        _keepRootPosition: boolean;
        _direction: number;
        _stretchFactor: number;
        _reversedLinks: boolean;
    }
    import { Layout } from "Graphs/Layout";
    import TreeHelper from "Graphs/TreeHelper";
...
declare module "@mindfusion/graphs" {
    ...
    export { RadialTreeLayout } from "Graphs/RadialTreeLayout";
}
