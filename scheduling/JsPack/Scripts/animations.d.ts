    ...
    */
    export class Animation extends Disposable {
        ...
        */
        ...
        set repeatCount(arg: number);
        /**
        * Gets or sets a value indicating how many times to repeat the animation.
        * @type {Number}
        * @summary A number specifying the repeat count.
        */
