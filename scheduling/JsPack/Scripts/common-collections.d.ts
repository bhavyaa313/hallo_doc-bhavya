...
declare module "@mindfusion/common-collections" {
    ...
    */
    ...
    export class IEnumerable<T> {
        ...
        * @param {Number} index The index.
        * @param {T} item The object to move.
        */
        ...
        */
        ...
        /**
        * Returns a grouped view of the collection items.
        * @param {string} key The item field to group by.
        */
        groupBy: (key: any) => {};
        /**
        * Returns an intersection of the provided list and the current collection.
        * @param {IEnumerable} list The list to intersect with.
        */
        intersects(list: any): IEnumerable<unknown>;
        /**
    ...
    export class ObservableCollection<T> extends List<T> implements INotifyPropertyChanged, INotifyCollectionChanged, INotifyCollectionChanging {
        ...
        */
         ...
         */
        removeAt(itemIndex: number): boolean;
        /**
         * Clears the collection
         */
        clear(): void;
