...
declare module "DataViews/jsdv/src/DataType" {
   ...
   */
    class DataType {
        /**
        * Return the sort order of specified values.
        * @param {Object} value1 The first value to compare.
        * @param {Object} value2 The second value to compare.
        * @returns {Number} A negative number if value1 < value2, 0 if values are equal,
        * or a positive number if value1 > value2.
        */
        static sortFunction(value1: any, value2: any): number;
        /**
        * Creates an editor for specified value.
        * @param {DOMElement} element The parent DOM element where editor should be added.
        * @param {String} displayValue The label to display for value.
        * @param {Object} value The value to edit.
        * @param {Object} view The parent control.
        * @returns {DOMElement} The DOM element used to edit the value.
        */
        static createEditor(element: any, displayValue: string, value: any, view: any): any;
        /**
        * Parses value from specified string.
        * @param {String} text Textual representation of the value.
        ...
        * @param {Object} value1 The first value to compare.
        * @param {Object} value2 The second value to compare.
        * @returns {Boolean} true if values are equal, or false otherwise.
        */
