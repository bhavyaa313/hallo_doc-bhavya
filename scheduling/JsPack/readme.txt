...
~ TabbedView ~ demonstrates the functionality of the TabbedDiagramView control.
...
~ AreaChart ~ This sample demonstrates various properties of the AreaChart control.

~ BarChart ~ This sample demonstrates various properties of the BarChart control.

~ BarChart3D ~ This sample demonstrates various properties of the BarChart3D control.

~ BubbleChart ~ This sample demonstrates various properties of the BubbleChart control. 
...
~ PieChart ~ This sample demonstrates various properties of the PieChart control.
...
MindFusion.Scheduling
 - calendar registered as web component

MindFusion.DataViews
 - grid registered as web component

version 2023.R2:

MindFusion.Diagramming
 - support for multiple diagram pages by the DiagramDocument class 
 - TabbedDiagramView control
 - black theme
 - Theme.fromId static method for loading a predefined theme by string id
 - DiagramItem.opacity property
 - validateAnchorPoint and validateLinkCrossing events
...
MindFusion.Diagramming
  ...
  - styled text and text wrapping in ItemLabel
  - ArrowHeads lists standard arrowhead shapes
  - custom stroke dash patterns

MindFusion.Scheduling
  - localization files for chinese, spanish, french, italian, korean, dutch, portuguese, turkish, polish, japanese locales
...
Copyright (C) 2019-2023, MindFusion LLC, Bulgaria
All rights reserved.
