...
public Physician(int physicianId, AspNetUsers aspnetUserId, String firstName, String lastName, String email,
		...
		int regionId, String zip, String altPhone, int createdBy, LocalDateTime createdDate, int modifiedBy,
		LocalDateTime modifiedDate, int status, String businessName, String businessWebsite, boolean isDeleted,
		int roleId, String npiNumber, boolean isLicenseDoc, String signature, String syncEmailAddress) {
	super();
	this.physicianId = physicianId;
	this.aspnetUserId = aspnetUserId;
	this.firstName = firstName;
