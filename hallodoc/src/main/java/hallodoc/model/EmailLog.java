...
public class EmailLog {
	...
	public EmailLog(int email_log_id, String subject_name, String email_id, String confirmation_number, int role_id,
			int request_id, int admin_id, int physician_id, LocalDateTime created_date, LocalDateTime sent_date,
			boolean is_email_sent, int sent_tries, String action) {
		super();
		this.email_log_id = email_log_id;
		this.subject_name = subject_name;
		this.email_id = email_id;
	...
	public String toString() {
		return "EmailLog [email_log_id=" + email_log_id + ", subject_name=" + subject_name + ", email_id=" + email_id
				+ ", confirmation_number=" + confirmation_number + ", role_id=" + role_id + ", request_id=" + request_id
				+ ", admin_id=" + admin_id + ", physician_id=" + physician_id + ", created_date=" + created_date
				+ ", sent_date=" + sent_date + ", is_email_sent=" + is_email_sent + ", sent_tries=" + sent_tries
				+ ", action=" + action + "]";
	}
