        ...
        <div class="foot">
            <div class="container-fluid  kok bg-light">
                ...
                <div class="d-flex justify-content-between bg-light">
                    <div class="">
                        <img class="hello-logo1 mt-2" src="<c:url value="/resources/images/hellodoc-logo.png" />" alt="">
                    </div>
                    ...
                    <div class="col-12 col-md-6  ">
                        <div class="container-fluid bg-light">
                            <div class="d-flex mb-3">
                                ...
                                <div class="ms-auto p-3"> <a href="javascript: history.go(-1)"href="select.html" type="button"
                        ...
                        <form action="" method="post" ></form>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md">
                                    <div class="form-floating mb-3">
                                        <input type="tel" class="form-control pt-3 pb-3  iti iti__country-list"
                                            id="phone">
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput"
                                            placeholder="trrrrrrrrrr">
                                        <label for="floatingInput" class="dm">Relation With Patient (Optional)</label>
                                    </div>
                                </div>
                            </div>
