			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content rounded-4">
					<div class="modal-body">
						...
						<p class="mx-3 d-flex justify-content-center">When providing a
							request you must provide the correct contact information for the
							patient or the responsible party. Failure to provide the correct
							email and phone number will delay service or be declined.</p>
					</div>
		...
		<div class="container-fluid ">
			<div class="row">
				...
				<div class="col-12 col-md-6 bg-white ">
					...
					<form action="conciergeInfo" method="post"
						>
						<div class="row g-2">
							<div class="col-md col-10">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="floatingInput"
										...
										for="floatingInput" class="dm"> Your First Name</label>
								</div>
							</div>
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="floatingInput"
										...
										for="floatingInput" class="dm"> Your Last Name</label>
								</div>
							</div>
						</div>
						<div class="row g-2">
							...
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="email" class="form-control" id="floatingInput"
										placeholder="name" mailto:placeholder="name@example.com"
										name="email"> <label for="floatingInput" class="dm">Your
										Email</label>
								</div>
							</div>
							...
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="floatingInput"
										...
										class="dm">Hotel/Property Name</label>
								</div>
							</div>
						</div>
						...
						<div class="row g-2">
							...
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="floatingInput"
										placeholder="tre" name="zipcode"> <label
						...
						<div class="row g-2">
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="floatingInput"
										placeholder="name" name="pFirstName"> <label
							...
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="floatingInput"
										placeholder="name" name="plastName"> <label
						...
						<div class="row g-2">
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="email" class="form-control" id="floatingInput"
										placeholder="name@example.com" name="pEmail"> <label
