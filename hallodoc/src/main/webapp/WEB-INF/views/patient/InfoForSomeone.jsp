					...
					<div class="container-fluid bg-light">
						<div class="d-flex mb-3">
							...
							<div class="ms-auto p-3">
								<a href="javascript: history.go(-1)" href="select.html"
									type="button" class="btn btn-outline-info mx-2 lo"> < Back</a>
							</div>
						</div>

					</div>
					<form action="${pageContext.request.contextPath}/submitInfo/${userID}" method="post"
						...
						<div class="bg-white p-3">
							...
							<div class="row g-2">
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="name" name="pFname"> <label
								...
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="name" name="pLname"> <label
							...
							<div class="row g-2">
								<div class="col-md-6">
									<div class="form-floating mb-3">
										...
										<input type="text" id="uname" class="form-control" name="pDob"
											placeholder="Date Of Birth" onfocus="(this.type='date')"></input>
								...
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="email" class="form-control" id="floatingInput"
											name="pEmail" placeholder="name@example.com"> <label
											for="floatingInput" class="dm">Email</label>
									</div>
								</div>
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="tel" name="pPhoneNo"
							...
							<div class="row g-2">
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="rttttttth" name="pStreet"> <label
								...
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="trr" name="pCity"> <label
							...
							<div class="row g-2">
								...
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="tre" name="pZipCode"> <label
							...
							<div class="row g-2">
								<div class="col-md-6">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="trrrrrrrrrr"> <label for="floatingInput"
											class="dm">Relation With Patient (Optional)</label>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col">
									<div class="input-group mb-3 drill_cursor mt-3">
										<input type="file" name="file" id="input_file" hidden>
