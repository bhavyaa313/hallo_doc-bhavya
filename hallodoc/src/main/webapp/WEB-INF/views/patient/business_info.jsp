					...
					<form action="business" method="post">
							...
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="email" class="form-control" id="floatingInput"
										name="email" mailto:placeholder="name@example.com"> <label
						...
						<div class="row g-2">
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="floatingInput"
										placeholder="name" name="businessName"> <label
										for="floatingInput" class="dm">Business/Property Name</label>
								</div>
							</div>
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="floatingInput"
										placeholder=""> <label for="floatingInput" class="dm">Case
							...
							<div class="col-md col-12">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="floatingInput"
										...
										class="dm" name="zipcode">Zip Code</label>
								</div>
							</div>
						</div>
