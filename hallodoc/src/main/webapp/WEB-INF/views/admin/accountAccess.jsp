			...
			<div class="container bg-light mt-3">
				<div class="  d-flex p-4  ">
					...
					<div class="ms-auto mt-3">
						<a href="createRole" type="button"
							class="btn btn-outline-info mx-2 "> create</a>
					</div>
						...
						<tbody>
							<c:forEach items="${roles}" var="r">
								<tr>
									...
									<td>${r.name }</td>
									<td><c:if test="${r.accountType == 1}">
        						    Admin
     								</c:if> <c:if test="${r.accountType == 2}">
        							Provider
     								</c:if> <c:if test="${r.accountType != 1 && r.accountType != 2}">
      								 all
      								</c:if></td>

									<td>
										<a type="button" href="${pageContext.request.contextPath}/deleteRole/${r.roleId}" class="btn btn-outline-info mx-2 ">
											Delete</a> <a href="editRole/${r.roleId }" type="button"
										class="btn btn-outline-info mx-2  "> Edit </a>
									</td>
								</tr>
						...
						<div id="panelsStayOpen-collapseTwo"
							...
							<div class="accordion-body">
								...
								<div class="mt-2">
									<button type="button" class="btn btn-outline-info mx-2 ">
										Delete</button>
									<a href="edit_role.html" type="button"
										class="btn btn-outline-info mx-2  "> Edit </a>
								</div>
							</div>
						</div>
						<div class="accordion-item">
							<h2 class="accordion-header">
								<button class="accordion-button collapsed" type="button"
									...
									aria-expanded="false"
									aria-controls="panelsStayOpen-collapseThree">Name:
									Nikunj</button>
							</h2>
