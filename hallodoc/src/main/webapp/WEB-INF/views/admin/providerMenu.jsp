	...
	<div>
		<div class="bg-light">
				...
				<div class="  d-flex p-4  ">
					...
					<div class="ms-auto ">
						<a href="javascript: history.go(-1)" type="button"
							class="btn btn-outline-info mx-2 mt-3 "> < Back</a>
					</div>
			...
			<div class="container bg-white ">
				...
				<div class="  d-flex p-4  ">
					<div class="col-lg-4 d-md-flex d-block"></div>
					<!-- <img class="uicon3" src="images/search.svg" alt=""> -->

					<div class="ms-auto ">
						<a href="addProvider" type="button" class="btn btn-info mx-2 lo">
				...
				<div class="lo">
					<table class="table" id="myTable">
						...
						<tbody>
							<c:forEach items="${phy}" var="p">
								<tr>

									<td>
										<div class="form-check">
											<input class="form-check-input" type="checkbox" value=""
												id="flexCheckChecked" name="stop" checked> <label
									...
									<td>
										<button type="button" class="btn btn-outline-info mx-2 "
											data-bs-toggle="modal" data-bs-target="#contact"
											 onclick="contact(`${p.email}`)">Contact</button> <a
										href="editProvider/${p.physicianId }" type="button"
							...
							<button class="accordion-button" type="button"
								...
								<div class="form-check">
									<input class="form-check-input" type="checkbox" value=""
										...
										for="flexCheckChecked"> </label> Nikunj
								</div>
					...
					<div class="modal-content">
						...
						<form action="${pageContext.request.contextPath}/contact"
							...
							<div class="modal-body">
								...
								<input id="aa" type="text" value="" name="emailsend" hidden>
							...
							<div class="modal-footer">
								...
								<button type="submit" class=" btnbtn-info">Send</button>
