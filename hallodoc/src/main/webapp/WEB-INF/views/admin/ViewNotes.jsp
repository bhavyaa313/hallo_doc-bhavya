                            ...
                            <div class="row">
                                ...
                                <div class="col-md-11 col-10">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">${viewNotesDtos.transferNote } </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-11 col-10">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">${viewNotesDtos.physicianNote }</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row d-flex justify-content-evenly mb-3">
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-11 col-10">
                                  <div class="card-body">
                                      ...
                                      <p class="card-text">${viewNotesDtos.adminNote } </p>
                                  </div>
                              </div>
                          </div>
                      ...
                      <div class="card mt-3" style="width: 27rem;">
                          <div class="row">
                              ...
                              <div class="col-md-11 col-10">
                                  <div class="card-body">
                                      <h5 class="card-title">Admin Cancellation Notes</h5>

                                      <p class="card-text">${viewNotesDtos.adminCancellationNote }</p>
                                  </div>
                              </div>
                          </div>
                    ...
                    <div class="row d-flex justify-content-evenly mb-3">
                        <div class="card  " style="width: 27rem;">
                            <div class="row">
                                ...
                                <div class="col-md-11 col-10">
                                    <div class="card-body">
                                        <h5 class="card-title">Patient Cancellation Notes</h5>

                                        <p class="card-text">${viewNotesDtos.patientCancellationNote } </p>
                                    </div>
                                </div>
                            </div>
