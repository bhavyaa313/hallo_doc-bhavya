		...
		<div class="bg-light">
			...
			<div class="container-fluid bg-light mt-3">
				<div class="  d-flex p-4  ">
					...
					<div class="ms-auto ">
						<a href="" type="button" class="btn btn-outline-info mx-2 lo">
							Export Data To Excel</a> <a href="" type="button"
							class="btn btn-outline-info mx-2 lo-btn"> <i
					...
					<div class="row g-2">
						<div class="col-md">
							<div class="form-floating">
								...
								</select> <label for="floatingSelect">Select Request Status</label>
							</div>
						...
						<div class="col-md">
							...
							<div class="form-floating">
								...
								</select> <label for="floatingSelect">Select Request Type</label>
							</div>

						</div>
						<div class="col-md">
							<div class="form-floating mb-3">
								<input type="date" class="form-control" id="DOS"
									placeholder="name"> <label for="floatingInput"
									class="dm">From Date of servicer</label>
							</div>
						</div>
					</div>
					<div class="row g-2">
						<div class="col-md">
							<div class="form-floating mb-3">
								<input type="date" class="form-control" id="TDOS"
									placeholder="name"> <label for="floatingInput"
									class="dm">To Date Of Service</label>
							</div>
						</div>
						<div class="col-md">
							<div class="form-floating mb-3">
				...
				<div class="container-fluid bg-white ">
					...
					<div class="  d-flex p-4  ">
						...
						<div class="ms-auto ">
							...
							<button type="reset" class="btn btn-outline-info mr-2 clear">Clear
							</button>
										...
										<div class="col-12">
											<div class="form-check">
												<input class="form-check-input" type="checkbox" value=""
													id="flexCheckDefault"> Testing
											</div>
										</div>



										<div class="col-12">Dc, Dc, Dc</div>
								...
								<div class="accordion-body">
									...
									<div>
										<span class="mx-2"><button
											...
											</button></span> Requestor: Family/Friend
									</div>
									...
									<div>
										<span class="mx-2"><button
											...
											</button></span> Cancellation reasons: xyz
									</div>
				...
				success : function(data) {
					...
					for(let i=0; i<data.length; i++) {
						...
						var row = `<tr>
							...
							<td>`+s.patientNote+`</td>
							<td>
							<a href="deleteRecord/`+s.reqId+`" type="button" class="btn btn-outline-info mx-2 ">
								Delete</a>
						</td>
