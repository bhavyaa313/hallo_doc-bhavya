		...
		<div class="container-fluid bg-white ">
			...
			<div class="lo">
				<table class="table">
					...
					<tbody>
						<c:forEach items="${patientRecords}" var="p">
							<tr>
								...
								<td>-</td>
								<td>${p.status }</td>
								<td><a class=" dropdown-toggle btn btn-outline-info mx-2"
									href="#" role="button" data-bs-toggle="dropdown"
									aria-expanded="false"> Actions </a>


									<ul class="dropdown-menu">
										<li><a class="dropdown-item" href="${pageContext.request.contextPath}/viewCase/${p.rId}">View Case</a></li>
					...
					<h2 class="accordion-header">
						<button class="accordion-button" type="button"
							...
							<div class="row w-100">
								...
								<div class="col-12">942613402</div>
