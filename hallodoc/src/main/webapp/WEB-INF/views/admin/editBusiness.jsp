			...
			<div class="row">
				...
				<div class="col-12 col-md-8 ">
					...
					<div class="bg-white p-3">
						...
						<form action="updateBusiness/${vendorId }" method="post">

							<div class="row g-2">
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="name" name="name" value="${health.vendorName }"> <label
								...
								<div class="col-md">
									<div class="form-floating">
										...
										</select> <label for="floatingSelect">Select Profession</label> <label
											for="floatingSelect">Profession</label>
							...
							<div class="row g-2">
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput" value="${health.faxNumber }"
											placeholder="name" name="fax"> <label
								...
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="tel" value="${health.phoneNumber }"
							...
							<div class="row g-2">
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="email" class="form-control" id="floatingInput"
											placeholder="name" name="email" value="${health.email }"> <label
								...
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="name" name="bcontact" value="${health.businessContact }"> <label
							...
							<div class="row g-2">
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="name" name="street"> <label
								...
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="name" name="city" value="${health.city }"> <label
							...
							<div class="row g-2">
								<div class="col-md">
									<div class="form-floating mb-3">
										<select class="form-select"
											aria-label="Default select example" placeholder="tre" name="state">
								...
								<div class="col-md">
									<div class="form-floating mb-3">
										<input type="text" class="form-control" id="floatingInput"
											placeholder="name" name="zip" value="${health.zip }"> <label
											for="floatingInput" class="dm">Zip/postal</label>
									</div>
								</div>
							</div>
							...
							<div class="mt-4 d-flex flex-row-reverse mb-3  ">
								...
								<button type="button" class="btn btn-outline-info btn-lg mx-2">Cancel</button>
