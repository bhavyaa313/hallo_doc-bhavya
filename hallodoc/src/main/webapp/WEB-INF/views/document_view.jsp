...
<script src="<c:url value="/resources/js/script.js"/>"></script>
  <link href="<c:url value="/resources/css/card_view.css"/> "  rel="stylesheet">
...
<div class="foot" style="padding-bottom: 150px;">
    <div class="container ">
        <div class="  d-flex p-4  ">
            ...
            <div class="ms-auto "> <a href="javascript: history.go(-1)" type="button" class="btn btn-outline-info mx-2 lo">
                    < Back</a>
            </div>
    ...
    <div class="container bg-light ">
        <div class=" p-3   ">
            ...
            <div class="text-info fs-3 p-1 mx-2">Testing Test <span class="text-muted fs-4"> (MCD86543092)</span> </div>
            <div class="text-muted p-1 mx-2"> Check here for any files that you or the doctors of your subsequents have
                attached
            ...
            <div class="row mx-2  p-1">
                <div class="col">
                    <div class="input-group mb-3 drill_cursor mt-3">
                        ...
                        <input type="text" class="form-control col-form-label-lg " id="txt" onclick="open_file"
                            placeholder="Upload " aria-label="Upload" aria-describedby="button-addon2">
                        <button class="btn btn-outline-info bg-info " type="button" onclick="open_file()"
                            id="button-addon2">
                            <img src="images/cloud-arrow-up.svg" alt="">
                            <span style="color: white;" class="lo">Upload</span>
                        </button>
            ...
            <div class="  d-flex p-4  ">
                ...
                <div class="ms-auto "> <a href="select.html" type="button" class="btn btn-outline-info mx-2 lo">
                        Download all</a>
