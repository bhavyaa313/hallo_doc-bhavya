...
<script src="<c:url value="/resources/js/script.js"/>"></script>    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="input-group mb-3 drill_cursor mt-3">
                                ...
                                <input type="text" class="form-control col-form-label-lg " id="txt" onclick="open_file" placeholder="Upload " aria-label="Upload" aria-describedby="button-addon2">
                                <button class="btn btn-outline-info bg-info" type="button" onclick="open_file()" id="button-addon2"> 
