			...
			<div class="row">
				...
				<div class="col-12 col-md-8 ">
					...
					<div class="bg-white p-3">
						...
						<form action="${pageContext.request.contextPath}/new/${userID}/${id}" method="POST">
							...
							<div class="form-floating mb-3">
								<textarea class="form-control "
									placeholder="Leave a comment here" id="floatingTextarea2"
									style="height: 100px" name="providerNotes"></textarea>
								<label for="floatingTextarea2" class="dm"> Provider Notes <span
