	...
	<div class="foot " style="padding-bottom: 200px;">
		<div class="container ">
			<div class="  d-flex p-4  ">
				<h3 class="mx-2">Conclude Care</h3>
				<div class="ms-auto ">
		...
		<div class="container bg-light ">
			<div class=" p-3   ">
				...
				<div class="text-info fs-3 p-1 mx-2">${requestClients[0].firstName}
					${requestClients[0].lastName}</div>


				<div class="row   p-1">
					<div class="col-md-10 col-10">
						<div>
							<h4 class="mx-2">Encounter Forms</h4>

						</div>
					</div>
					<form
						action="${pageContext.request.contextPath}/uploadConclude/${requestId}/${userList[0].userID}/uploadFile"
						method="post" enctype="multipart/form-data">



						<div class="input-group mb-3 drill_cursor mt-3 ms-auto">
							...
							<input type="text" class="form-control col-form-label-lg "
								...
								aria-label="Upload" aria-describedby="button-addon2" hidden>
						...
						<button type="submit" id="hiddenSubmit" hidden>submit</button>
					</form>
				</div>
							...
							<c:forEach items="${requestWiseFiles}" var="f">
								...
								<tr>
									...
									<td><a href="${ f.filePath} " download="${f.fileName }"
										...
										href="${pageContext.request.contextPath}/concludeCare/${requestId}/${f.id}/delete"
										class="btn btn-outline-info mx-2 delete "> <svg
												xmlns="http://www.w3.org/2000/svg" width="16" height="16"
					...
					<div class="accordion-item">
						<h2 class="accordion-header">
							<button class="accordion-button" type="button"
								...
								aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">Test</button>
						</h2>
			...
			<div>
				...
				<form
					action="${pageContext.request.contextPath}/concludeCare/${requestId }"
					method="post">
					<div style="border: 5px solid #edf4f4;"
						...
						<div class="row pt-2 mt-2 mb-3">
							...
							<div class="col-md-12">
								<div class="form-group form-floating mt-2">
									<textarea style="height: 150px;" class="form-control"
										name="providerNote" placeholder="Provider NOte"></textarea>
							...
							<div class="d-flex pt-2 justify-content-end">
								...
								<button type="submit" class="btn btn-info mr-2">Conclude
									Care</button>
